...
### Migrate Lb2 via Swagger.json

![Get Lb2 Swagger.json](media/api-explorer.png)

### Resources

 - [Strong-Docs](https://github.com/strongloop/strong-docs) - npm module that creates this documentation.
 - [Lb4 OpenAPI CLI](https://strongloop.com/strongblog/loopback4-openapi-cli/) - Migrate Lb2 via Swagger.json
